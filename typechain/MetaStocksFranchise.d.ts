...
interface MetaStocksFranchiseInterface extends ethers.utils.Interface {
  functions: {
...
export class MetaStocksFranchise extends BaseContract {
  ...
  interface: MetaStocksFranchiseInterface;
